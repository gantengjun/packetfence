...
New Features
++++++++++++
* Enable mschap authentication for CLI/VPN access
...
* CoA support for Unifi AP
* Added a way to define the Unifi AP by IP or IP range.

Bug Fixes
+++++++++
* Fixes FortiGate returnAuthorizeVPN function (#5409)
* Barracuda NG firewall SSO SSH fail (#4828)
* Impossible to set multiple access level in administration rule (#5440)
* Allow to run a scan even if we don't have OS (#5463)
